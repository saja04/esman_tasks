...
public class Task
{
    public int TaskId; // the number/order of the task inside that user's tasks
...
public class CPHInline
{
    public bool Execute()
    {
        ...
        {
            message = $"Nombre de la tarea: {foundTask.TaskName}. Descripcion de la tarea: {foundTask.TaskDescription}. La tarea fue agregada el {foundTask.TaskDateAdded}";
        }
        else
        {
            message = "hubo un error al mostrar la task, xd";
        }
